...
Source code: https://github.com/ooadeniyi71/openshift-clusterconfig-gitops/tree/main/clusters/management-cluster/generic-clusterconfig

## Local Parameters

**TIP** Verify the chart(s):
- [generic-cluster-config](https://github.com/ooadeniyi71/helm-charts/tree/main/charts/generic-cluster-config)
