...
It mainly uses the Chart [cost-management](https://github.com/ooadeniyi71/helm-charts/tree/main/charts/cost-management) which takes care of configuring the Operator.
The [values-file](https://github.com/ooadeniyi71/helm-charts/tree/main/charts/cost-management) of the main chart provides further examples of possible settings.
