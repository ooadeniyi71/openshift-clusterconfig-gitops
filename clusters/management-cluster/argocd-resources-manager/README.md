...
| repourl_configuration | string | `"https://github.com/ooadeniyi71/openshift-clusterconfig-gitops"` | The repourl_configuration parameter specifies the URL of the Git repository containing cluster configurations. |
...
spec:
  ...
  project: default
  sources:
    - repoURL: https://github.com/ooadeniyi71/openshift-clusterconfig-gitops
      targetRevision: main
      ref: values
...
This Application will observe https://github.com/ooadeniyi71/openshift-clusterconfig-gitops for any changes.
...
Source code: https://github.com/ooadeniyi71/openshift-clusterconfig-gitops/tree/main/base/init_app_of_apps
