...
It mainly uses the Chart [file-integrity-operator](https://github.com/ooadeniyi71/helm-charts/tree/main/charts/file-integrity-operator) which takes care of configuring the Operator.
The [values-file](https://github.com/ooadeniyi71/helm-charts/tree/main/charts/file-integrity-operator) of the main chart provides further examples of possible settings.
